		...
		<div class="well">
			<form id="memberForm" class="form-horizontal">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="text" id="birth" name="birth" maxlength="6" class="form-control" placeholder="주민등록번호 앞 6자리">
					</div>
					<div class="col-sm-2">
						<input type="text" id="gender" name="gender" maxlength="1" class="form-control" placeholder="주민등록번호 뒤 7자리 중 맨 앞 1자리">
					</div>
					<div class="col-sm-5">
						<p class="form-control-static error"></p>
					</div>
