		...
		<div class="well">
			<form id="memberForm" class="form-horizontal">
				...
				<div class="form-group form-group-sm">
					<label for="userId" class="col-sm-2 control-label">사용자</label>
					<div class="col-sm-3">
						${member.userId}
					</div>
				</div>
				<div class="form-group form-group-sm">
					<label for="oldUserPw" class="col-sm-2 control-label">기존 비밀번호</label>
					<div class="col-sm-3">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="password" id="userPw" name="userPw" maxlength="15" class="form-control" placeholder="변경할 비밀번호 입력">
					</div>
					<div class="col-sm-5">
						<p class="form-control-static error"></p>
					</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="text" id="phone" name="phone" maxlength="15" class="form-control" value="${member.phone}">
					</div>
					<div class="col-sm-5">
						<p class="form-control-static error"></p>
					</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="text" id="emailName" name="emailName" maxlength="60" class="form-control" value="${email[0]}">
					</div>
					<div class="col-sm-2">
