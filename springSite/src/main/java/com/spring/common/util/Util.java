...
public class Util {
	 ...
	 * 참고 : .: 임의의 한문자 /?: 문자가 존재하지 않거나 하나의 문자 /*: 문자가 존재하지 않거나
	 * 		 하나 이상 반복 /+:문자가 한번이상 반복 (?=pattern) or 연산으로 정의된 패턴과 일치하는 문자열 /
	...
	***************************/
	 ...
	 * 표준 형식에서 UUID는 32개의 16진수로 표현되며 총 36개(32개문자와 4개의 하이픈)문자로 된 8-4-4-4-12라는 5개의 그룹을 하이픈으로 구분한다.
	 * 이를태면 다음과 같다. 853b5ba5-5941-48bc-81b0-aa42056bcc29
	 * 고유성을 완벽하게 보장할수는 없지만 실제 사용상에서 중복될 가능성이 거의 없다고 인정되기 때문에 많이 사용된다.
	***************************/
